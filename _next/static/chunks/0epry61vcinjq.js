(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,5180,e=>{"use strict";var a=e.i(91398),n=e.i(57724),i=e.i(3935),t=e.i(91788);let r=["angular-cli","create-react-app","html","javascript","node","polymer","typescript","vue"],o=["project","search","ports","settings"],c=["light","dark"],s=["editor","preview"],d={clickToLoad:e=>l("ctl",e),devToolsHeight:e=>u("devtoolsheight",e),forceEmbedLayout:e=>l("embed",e),hideDevTools:e=>l("hidedevtools",e),hideExplorer:e=>l("hideExplorer",e),hideNavigation:e=>l("hideNavigation",e),openFile:e=>g("file",e),showSidebar:e=>{var a;return"boolean"==typeof(a=e)?`showSidebar=${a?"1":"0"}`:""},sidebarView:e=>p("sidebarView",e,o),startScript:e=>g("startScript",e),terminalHeight:e=>u("terminalHeight",e),theme:e=>p("theme",e,c),view:e=>p("view",e,s),zenMode:e=>l("zenMode",e),organization:e=>`${g("orgName",e?.name)}&${g("orgProvider",e?.provider)}`,crossOriginIsolated:e=>l("corp",e)};function m(e={}){let a=Object.entries(e).map(([e,a])=>null!=a&&d.hasOwnProperty(e)?d[e](a):"").filter(Boolean);return a.length?`?${a.join("&")}`:""}function l(e,a){return!0===a?`${e}=1`:""}function u(e,a){if("number"==typeof a&&!Number.isNaN(a)){let n=Math.min(100,Math.max(0,a));return`${e}=${encodeURIComponent(Math.round(n))}`}return""}function p(e,a="",n=[]){return n.includes(a)?`${e}=${encodeURIComponent(a)}`:""}function g(e,a){return(Array.isArray(a)?a:[a]).filter(e=>"string"==typeof e&&""!==e.trim()).map(a=>`${e}=${encodeURIComponent(a)}`).join("&")}function y(){return Math.random().toString(36).slice(2,6)+Math.random().toString(36).slice(2,6)}function v(e={}){return("string"==typeof e.origin?e.origin:"https://stackblitz.com").replace(/\/$/,"")}class f{constructor(e){this.pending={},this.port=e,this.port.onmessage=this.messageListener.bind(this)}request({type:e,payload:a}){return new Promise((n,i)=>{let t=y();this.pending[t]={resolve:n,reject:i},this.port.postMessage({type:e,payload:{...a,__reqid:t}})})}messageListener(e){if("string"!=typeof e.data.payload?.__reqid)return;let{type:a,payload:n}=e.data,{__reqid:i,__success:t,__error:r}=n;this.pending[i]&&(t?this.pending[i].resolve(this.cleanResult(n)):this.pending[i].reject(r?`${a}: ${r}`:a),delete this.pending[i])}cleanResult(e){let a={...e};return delete a.__reqid,delete a.__success,delete a.__error,Object.keys(a).length?a:null}}class b{constructor(e,a){this.editor={openFile:e=>this._rdc.request({type:"SDK_OPEN_FILE",payload:{path:e}}),setCurrentFile:e=>this._rdc.request({type:"SDK_SET_CURRENT_FILE",payload:{path:e}}),setTheme:e=>this._rdc.request({type:"SDK_SET_UI_THEME",payload:{theme:e}}),setView:e=>this._rdc.request({type:"SDK_SET_UI_VIEW",payload:{view:e}}),showSidebar:(e=!0)=>this._rdc.request({type:"SDK_TOGGLE_SIDEBAR",payload:{visible:e}})},this.preview={origin:"",getUrl:()=>this._rdc.request({type:"SDK_GET_PREVIEW_URL",payload:{}}).then(e=>e?.url??null),setUrl:(e="/")=>{if("string"!=typeof e||!e.startsWith("/"))throw Error(`Invalid argument: expected a path starting with '/', got '${e}'`);return this._rdc.request({type:"SDK_SET_PREVIEW_URL",payload:{path:e}})}},this._rdc=new f(e),Object.defineProperty(this.preview,"origin",{value:"string"==typeof a.previewOrigin?a.previewOrigin:null,writable:!1})}applyFsDiff(e){let a=e=>null!==e&&"object"==typeof e;if(a(e)&&a(e.create)){if(!Array.isArray(e.destroy))throw Error("Invalid diff object: expected diff.destroy to be an array.")}else throw Error("Invalid diff object: expected diff.create to be an object.");return this._rdc.request({type:"SDK_APPLY_FS_DIFF",payload:e})}getDependencies(){return this._rdc.request({type:"SDK_GET_DEPS_SNAPSHOT",payload:{}})}getFsSnapshot(){return this._rdc.request({type:"SDK_GET_FS_SNAPSHOT",payload:{}})}}let h=[];class w{constructor(e){this.id=y(),this.element=e,this.pending=new Promise((e,a)=>{let n=({data:a,ports:n})=>{a?.action==="SDK_INIT_SUCCESS"&&a.id===this.id&&(this.vm=new b(n[0],a.payload),e(this.vm),t())},i=()=>{this.element.contentWindow?.postMessage({action:"SDK_INIT",id:this.id},"*")};function t(){window.clearInterval(o),window.removeEventListener("message",n)}window.addEventListener("message",n),i();let r=0,o=window.setInterval(()=>{if(this.vm)return void t();if(r>=20){t(),a("Timeout: Unable to establish a connection with the StackBlitz VM"),h.forEach((e,a)=>{e.id===this.id&&h.splice(a,1)});return}r++,i()},500)}),h.push(this)}}function S({template:e,title:a,description:n,dependencies:i,files:t,settings:o}){if(!r.includes(e)){let e=r.map(e=>`'${e}'`).join(", ");console.warn(`Unsupported project.template: must be one of ${e}`)}let c=[],s=(e,a,n="")=>{var i;let t;c.push((i="string"==typeof a?a:n,(t=document.createElement("input")).type="hidden",t.name=e,t.value=i,t))};s("project[title]",a),"string"==typeof n&&n.length>0&&s("project[description]",n),s("project[template]",e,"javascript"),i&&("node"===e?console.warn("Invalid project.dependencies: dependencies must be provided as a 'package.json' file when using the 'node' template."):s("project[dependencies]",JSON.stringify(i))),o&&s("project[settings]",JSON.stringify(o)),Object.entries(t).forEach(([e,a])=>{s(`project[files][${e.replace(/\[/g,"%5B").replace(/\]/g,"%5D")}]`,a)});let d=document.createElement("form");return d.method="POST",d.setAttribute("style","display:none!important;"),d.append(...c),d}let k=function(e,a,n){var i;let t,r,o=function(e){if("string"==typeof e){let a=document.getElementById(e);if(!a)throw Error(`Could not find element with id '${e}'`);return a}if(e instanceof HTMLElement)return e;throw Error(`Invalid element: ${e}`)}(e),c=(r=S(a),t={forceEmbedLayout:!0},(i=n)&&"object"==typeof i&&Object.assign(t,i),r.action=`${v(t)}/run${m(t)}`,r.id="sb_run",`<!doctype html>
<html>
...
<body>
  ...
  <script>document.getElementById('${r.id}').submit();</script>
...
</html>`),s=document.createElement("iframe");return function(e,a,n){if(!a||!e||!e.parentNode)throw Error("Invalid Element");e.id&&(a.id=e.id),e.className&&(a.className=e.className),function(e,a={}){let n=Object.hasOwnProperty.call(a,"height")?`${a.height}`:"300",i=Object.hasOwnProperty.call(a,"width")?`${a.width}`:void 0;e.setAttribute("height",n),i?e.setAttribute("width",i):e.setAttribute("style","width:100%;")}(a,n),function(e,a,n={}){let i=e.allow?.split(";")?.map(e=>e.trim())??[];n.crossOriginIsolated&&!i.includes("cross-origin-isolated")&&i.push("cross-origin-isolated"),i.length>0&&(a.allow=i.join("; "))}(e,a,n),e.replaceWith(a)}(o,s,n),s.contentDocument?.write(c),function(e){let a;return e?.contentWindow?(a=e instanceof Element?"element":"id",h.find(n=>n[a]===e)??null??new w(e)).pending:Promise.reject("Provided element is not an iframe.")}(s)},C=function(e,a){var n,i;let t;t=S(e),n=a,t.action=`${v(n)}/run${m(n)}`,t.target=(i=a)&&!1===i.newWindow?"_self":"_blank",document.body.appendChild(t),t.submit(),document.body.removeChild(t)};var E=e.i(24845);let I={CarService:`export const CarService = {
    ...
    `},A="PrimeReact is an open source UI library for React featuring a rich set of 80+ components, a theme designer, various theme alternatives such as Material, Bootstrap, Tailwind, premium templates and professional support. In addition, it integrates with PrimeBlock, which has 370+ ready to use UI blocks to build spectacular applications in no time.",D=E.default?E.default.dependencies:{},q={"@types/react-dom":"^18.0.0","@vitejs/plugin-react":"^1.3.0",typescript:"^4.6.3"},M={"tsconfig.json":{content:`{
  "compilerOptions": {
    "target": "ESNext",
...
}`}},P=(e={},a="javascript")=>{let n,i,t,r="src/",o=e.embedded,c="typescript"===a,s=c?"tsx":"jsx",{code:d,title:m="primereact_demo",description:l="",dependencies:u={}}=e,p={...(n={"@types/react":"^18.2.38",react:D.react||"latest","react-dom":D["react-dom"]||"latest","react-transition-group":D["react-transition-group"]||"latest",primereact:"latest",primeicons:D.primeicons||"latest",vite:"latest","@vitejs/plugin-react":"latest",...c?q:""},o?{...n,tailwindcss:D.tailwindcss||"latest",postcss:D.postcss||"latest",autoprefixer:D.autoprefixer||"latest"}:{...n,primeflex:D.primeflex||"latest"}),...u,"react-scripts":"5.0.1"},g={};d.extFiles&&Object.entries(d.extFiles).forEach(([e,a])=>{g[`${r+e}`]={content:a}});let y={content:{name:m.toLowerCase().replaceAll(" ","_"),description:`**${l}** ${A}`,type:"module",scripts:{dev:"vite",build:c?"tsc && vite build":"vite build",preview:"vite preview"},main:`${r}main.${s}`,keywords:["primereact","react","vite","starter"],dependencies:p}},v={content:`import { fileURLToPath, URL } from 'node:url';
...
</html>`},b=o?(i=c?"tsx":"jsx",{"tailwind.config.js":{content:`/** @type {import('tailwindcss').Config} */
export default {
    darkMode: 'class',
    content: [
        './index.html',
...
}`},[`${r}main.${i}`]:{content:`import React from 'react';
...
const root = ReactDOM.createRoot(document.getElementById('root')${c?" as HTMLElement":""});
root.render(
    <React.StrictMode>
...
);`},[`${r}index.css`]:{content:`@tailwind base;
@tailwind components;
@tailwind utilities;
...
html.dark .card {
    background: #071426;
}`},[`${r}components/themeSwitcher.${i}`]:{content:`import React, { useState } from 'react';
const ThemeSwitcher = () => {
...
export default ThemeSwitcher;`}}):(t={content:`import React from 'react';
import ReactDOM from 'react-dom/client';
import 'primeicons/primeicons.css';
import { PrimeReactProvider } from 'primereact/api';
...
);`},{[`${r}main.${c?"tsx":"jsx"}`]:t,[`${r}index.css`]:{content:`html {
    font-size: 14px;
}
...
.card {
    ...
    border-radius: 10px;
    margin-bottom: 1rem;
}`}}),h={"package.json":y,"vite.config.js":v,"index.html":f,[`${r}flags.css`]:B,[`${r}App.${s}`]:{content:d[a].replace(/^\n/,"")},...g,...b,...c?M:""};return e.service&&e.service.forEach(e=>{h[`${r}service/${e}.${s}`]={content:I[e]}}),{files:h,dependencies:p,sourceFileName:`${r}App.${s}`}},B={content:`span.flag {
    width: 44px;
    height: 30px;
...
}`};var T=e.i(57294);e.s(["DocSectionCode",0,function(e){var r,o;let[c,s]=(0,t.useState)("basic"),[d,m]=(0,t.useState)(e.code.javascript?"javascript":"basic"),l=(o=r={...e,template:"vite"},{openCodeSandbox:(e,a)=>{fetch("https://codesandbox.io/api/v1/sandboxes/define?json=1",{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify((e=>{let{files:a,dependencies:n,sourceFileName:i}=P({dependencies:{vite:"^4.0.0","@vitejs/plugin-react":"^4.0.0"},...o},e);return a["sandbox.config.json"]={content:{infiniteLoopProtection:!1,container:{node:"16"}}},{files:a,dependencies:n,sourceFileName:i}})(e))}).then(e=>e.json()).then(e=>window.open(`https://codesandbox.io/s/${e.sandbox_id}`,"_blank"))},openStackBlitz:(e,a)=>{let n=P(r,e);if(!n){a&&a({summary:"Not Available",detail:"That code sandbox demonstration is not available!"});return}let i={};Object.entries(n.files).forEach(([e,a])=>i[`${e}`]="object"==typeof a.content?JSON.stringify(a.content,null,2):a.content);let t={title:r.title||"PrimeReact Demo",template:"node",description:r.embedded?"This example demonstrates how to style components with Tailwind CSS using PrimeReact's unstyled property. As mentioned in the PrimeReact documentation, components can be styled or have HTML attributes added using a global or inline pass through approach. In this example, we utilize the global PT approach with Tailwind CSS.":"**"+(r.description||"")+"**\n PrimeReact is an open source UI library for React featuring a rich set of 90+ components, a theme designer, various theme alternatives such as Material, Bootstrap, Tailwind, premium templates and professional support. In addition, it integrates with PrimeBlock, which has 370+ ready to use UI blocks to build spectacular applications in no time.",dependencies:n.dependencies,files:i};r.embedded?k("embed",t,{openFile:"src/App.jsx",view:"default",height:"800px"}):C(t,{newWindow:!0,openFile:[n.sourceFileName]})}});(0,t.useEffect)(()=>{e.embedded&&l.openStackBlitz(d)},[l,d,e.embedded]);let u=async()=>{await navigator.clipboard.writeText(e.code[d])};return(0,a.jsxs)(a.Fragment,{children:[!e.embedded&&(0,a.jsxs)("div",{className:"doc-section-code",children:[(0,a.jsxs)("div",{className:"doc-section-code-buttons scalein animation-duration-300",children:["basic"!==c&&!e.hideToggleCode&&"data"!==c&&(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(n.Button,{className:(0,i.classNames)("py-0 px-2 border-round h-2rem shadow-none",{"code-active":"javascript"===d&&"data"!==c}),label:"JS",onClick:()=>m("javascript"),tooltip:"JavaScript Code",tooltipOptions:{position:"bottom",className:"doc-section-code-tooltip"}}),(0,a.jsx)(n.Button,{className:(0,i.classNames)("py-0 px-2 border-round h-2rem shadow-none",{"code-active":"typescript"===d}),label:"TS",onClick:()=>m("typescript"),tooltip:"TypeScript Code",tooltipOptions:{position:"bottom",className:"doc-section-code-tooltip"}})]}),!e.hideToggleCode&&(0,a.jsx)(n.Button,{type:"button",onClick:()=>{"data"===c?s("javascript"):s("basic"===c?"javascript":"basic"),m("javascript")},className:"h-2rem w-2rem p-0 inline-flex align-items-center justify-content-center shadow-none",tooltip:"Toggle Full Code",tooltipOptions:{position:"bottom",className:"doc-section-code-tooltip"},children:(0,a.jsx)("i",{className:"pi pi-code"})}),!e.hideToggleCode&&e.code.data?(0,a.jsx)(n.Button,{type:"button",onClick:()=>s("data"),className:"h-2rem w-2rem p-0 inline-flex align-items-center justify-content-center shadow-none",tooltip:"View Data",tooltipOptions:{position:"bottom",className:"doc-section-code-tooltip"},children:(0,a.jsx)("i",{className:"pi pi-database"})}):null,!e.hideStackBlitz&&(0,a.jsx)(n.Button,{type:"button",className:"h-2rem w-2rem p-0 inline-flex align-items-center justify-content-center shadow-none",tooltip:"Edit in StackBlitz",tooltipOptions:{position:"bottom",className:"doc-section-code-tooltip"},onClick:()=>l.openStackBlitz(d),children:(0,a.jsx)("svg",{role:"img",viewBox:"0 0 13 19",width:13,height:18,fill:"currentColor",style:{display:"block"},children:(0,a.jsx)("path",{d:"M0 10.6533H5.43896L2.26866 18.1733L12.6667 7.463H7.1986L10.3399 0L0 10.6533Z"})})}),(0,a.jsx)(n.Button,{type:"button",onClick:u,className:"h-2rem w-2rem p-0 inline-flex align-items-center justify-content-center shadow-none",tooltip:"Copy Code",tooltipOptions:{position:"bottom",className:"doc-section-code-tooltip"},children:(0,a.jsx)("i",{className:"pi pi-copy"})})]}),"basic"===c&&(0,a.jsx)("div",{className:e.codeClassName,children:(0,a.jsx)(T.CodeHighlight,{code:!0,...e,children:e.code.basic})}),"data"===c&&(0,a.jsx)("div",{className:e.codeClassName,children:(0,a.jsx)(T.CodeHighlight,{code:!0,lang:"json",children:e.code.data})}),"basic"!==c&&"javascript"===d&&(0,a.jsx)("div",{className:e.codeClassName,children:(0,a.jsx)(T.CodeHighlight,{code:!0,children:e.code.javascript})}),"basic"!==c&&"typescript"===d&&(0,a.jsx)("div",{className:e.codeClassName,children:(0,a.jsx)(T.CodeHighlight,{code:!0,lang:"tsx",children:e.code.typescript})})]}),e.embedded&&(0,a.jsx)("div",{id:"embed"})]})}],5180)}]);